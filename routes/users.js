...
router.post('/edit/:name', function(req, res) {
  var prod_name = req.params.name;
  const update_query = {
      text: "UPDATE product SET product_id=$1, product_name=$2, price=$3,amount = $4,shop_name=$5 WHERE product_name=$6",
      values: [req.body.product_id, req.body.product_name, req.body.price, req.body.amount, req.body.shop_name, prod_name]
  };
